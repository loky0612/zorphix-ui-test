...
const Faq = () => {
    ...
    const handleFaqButtonClick = (event) => {
    ...
    return (
        ...
        >
            <div className="container">
              ...
              "
                        >
                            <button className="faq-btn flex w-full items-center text-left" onClick={handleFaqButtonClick}>
                                <div
              ...
              "
                        >
                            <button class="faq-btn flex w-full items-center text-left" onClick={handleFaqButtonClick}>
                                <div
                                    className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-primary bg-opacity-5 text-primary"
                                >
                                    <svg
